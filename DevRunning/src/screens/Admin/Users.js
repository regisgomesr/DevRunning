    ...
    renderUser = user => {
        ...
        return(
            <Table.Row key={user.id}>
                ...
                <Table.Cell>
                <Button inverted color='blue' as={Link} to={`/admin/users/${user.id}/edit`}>Editar</Button>
                <Button inverted color='red' onClick={() => this.props.remove(user.id)}>Remover</Button>
                </Table.Cell>
            </Table.Row>
        )
    }
